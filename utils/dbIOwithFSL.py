...
from globalConst import DataBaseOperateType, FSLDataBaseInfo
...
class DatabaseIo:
    ...
    def __init__(self):
        ...
        self.db = MySQLdb.connect(
            FSLDataBaseInfo["address"],
            FSLDataBaseInfo["username"],
            FSLDataBaseInfo["passwd"],
            FSLDataBaseInfo["basename"],
            charset="utf8")
        if self.db:
